...
import (
	...
	jobnetes_v1beta "github.com/Attsun1031/jobnetes/pkg/apis/jobnetes/v1beta"
	versioned "github.com/Attsun1031/jobnetes/pkg/client/clientset/versioned"
	internalinterfaces "github.com/Attsun1031/jobnetes/pkg/client/informers/externalversions/internalinterfaces"
	v1beta "github.com/Attsun1031/jobnetes/pkg/client/listers/jobnetes/v1beta"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JobnetesV1beta().Workflows(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JobnetesV1beta().Workflows(namespace).Watch(options)
			},
		},
		&jobnetes_v1beta.Workflow{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jobnetes_v1beta.Workflow{}, f.defaultInformer)
}
