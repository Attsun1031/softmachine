...
import (
	...
	jobnetesv1beta "github.com/Attsun1031/jobnetes/pkg/apis/jobnetes/v1beta"
	clientset "github.com/Attsun1031/jobnetes/pkg/client/clientset/versioned"
	jobnetesscheme "github.com/Attsun1031/jobnetes/pkg/client/clientset/versioned/scheme"
	informers "github.com/Attsun1031/jobnetes/pkg/client/informers/externalversions"
	listers "github.com/Attsun1031/jobnetes/pkg/client/listers/jobnetes/v1beta"
...
func NewController(
	...
	eventBroadcaster.StartLogging(log.Logger.Infof)
	...
	log.Logger.Info("Setting up event handlers")
...
func (c *Controller) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	<-stopCh
	log.Logger.Info("Shutting down workers")
...
func (c *Controller) processNextWorkItem() bool {
	...
	err := func(obj interface{}) error {
		...
		c.workqueue.Forget(obj)
		log.Logger.Infof("Successfully synced '%s'", key)
		return nil
	}(obj)
